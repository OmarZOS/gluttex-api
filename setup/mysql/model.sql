...
CREATE TABLE IF NOT EXISTS `gluttex`.`product_consumption` (
  `resource_req_ref` INT NOT NULL,
  `consuming_service_id` INT NOT NULL,
  `consumed_product_id` INT NOT NULL,
  ...
  PRIMARY KEY (`resource_req_ref`, `consumed_product_id`, `consuming_service_id`),
