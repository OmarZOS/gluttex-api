...
CREATE TABLE IF NOT EXISTS `gluttex`.`payment` (
  ...
  `payment_status` ENUM('pending', 'processing', 'completed', 'partial', 'failed', 'refunded', 'cancelled') NULL DEFAULT 'pending',
...
CREATE TABLE IF NOT EXISTS `gluttex`.`deposit` (
  ...
  `deposit_method` ENUM('cash', 'card', 'bank_transfer', 'mobile_money', 'crypto', 'wallet', 'check') NOT NULL DEFAULT 'cash',
