...
class FinanceServiceClient:
    ...
    def confirm_payment(self, payment_id: int, transaction_details: Dict) -> PaymentResponse:
        """Confirm a payment"""
        pass
    
    def reject_payment(self, payment_id: int, reason: str) -> PaymentResponse:
        """Reject a payment"""
        pass
    
    def get_invoice_payments(self, invoice_id: int) -> InvoicePaymentSummary:
    ...
    def refund_payment(self, payment_id: int, refund_data: PaymentRefund) -> PaymentResponse:
        """Refund a payment"""
        pass
    
    def get_daily_stats(self, date: Optional[str] = None) -> DailyPaymentStats:
...
class InventoryServiceClient:
    ...
    def reserve_inventory(self, request: ReserveRequest) -> InventoryOperationResponse:
        """Reserve inventory"""
        pass
    
    def confirm_inventory(self, request: ConfirmRequest) -> InventoryOperationResponse:
        """Confirm inventory"""
        pass
    
    def release_inventory(self, request: ReleaseRequest) -> InventoryOperationResponse:
        """Release inventory"""
        pass
    
    def check_and_reserve(self, request: ReserveRequest) -> CheckAndReserveResponse:
        """Check and reserve in one operation"""
        pass
    ...
    def get_bulk_stock_status(self, product_ids: List[int]) -> Dict[int, StockStatusResponse]:
        """Get stock status for multiple products"""
        pass
    
    def get_available_quantity(self, product_id: int) -> AvailableQuantityResponse:
        """Get available quantity for a product"""
        pass
    
    def bulk_reserve(self, request: BulkInventoryRequest) -> BulkOperationResponse:
        """Bulk reserve inventory"""
        pass
    
    def bulk_confirm(self, request: BulkInventoryRequest) -> BulkOperationResponse:
        """Bulk confirm inventory"""
        pass
