...
SILO_SERVER_PROTOCOLE = os.getenv("SILO_SERVER_PROTOCOLE")
SILO_SERVER_NAME = os.getenv("SILO_SERVER_NAME")
SILO_SERVER_PORT = os.getenv("SILO_SERVER_PORT")
SILO_SERVER_PREFIX = os.getenv("SILO_SERVER_PREFIX")
SILO_SERVER_URL = f"{SILO_SERVER_PROTOCOLE}://{SILO_SERVER_NAME}:{SILO_SERVER_PORT}{SILO_SERVER_PREFIX}"

FINANCE_SERVER_PROTOCOLE = os.getenv("FINANCE_SERVER_PROTOCOLE")
FINANCE_SERVER_NAME = os.getenv("FINANCE_SERVER_NAME")
FINANCE_SERVER_PORT = os.getenv("FINANCE_SERVER_PORT")
FINANCE_SERVER_PREFIX = os.getenv("FINANCE_SERVER_PREFIX")
FINANCE_SERVER_URL = f"{FINANCE_SERVER_PROTOCOLE}://{FINANCE_SERVER_NAME}:{FINANCE_SERVER_PORT}{FINANCE_SERVER_PREFIX}"